// MLq4_librery_V3.mq4  —  Version 3 (Risk-based sizing + Equity guard)
// © MLq4 librery
...
#property strict
#property description "MLq4 librery – V3 adds risk % lot sizing and equity drawdown guard"

// ======== Inputs ========
extern string   EA_Name         = "MLq4_librery_V3";
...
// ======== NEW (V3): Risk-based lot sizing + Equity guard ========
...
/*
  Notes:
  - Risk lot is computed from SL_Points distance and broker tick value/size.
  - Equity guard: if Equity/Balance*100 < (100 - MaxDrawdownPct), no new trades.
*/
...
{
   // Calculate per-lot monetary risk using broker tick parameters
