// MLq4_librery_V4.mq4  —  Version 4 (HTF EMA trend filter)
// © MLq4 librery
...
#property strict
#property description "MLq4 librery – V4 adds higher-timeframe EMA trend filter"

// ======== Inputs ========
extern string   EA_Name         = "MLq4_librery_V4";
...
// ======== NEW (V4): Higher-Timeframe Trend Filter ========
...
/*
  Trend filter logic:
  - Compute EMA on HTF at shift 0.
  - If Close[0] < EMA: block buys. If Close[0] > EMA: block sells.
  - If EMA is unavailable (0 or NaN), the filter is skipped.
*/
